...
function AddNewBook({ setIsLoggedIn }) {
  ...
  const [pagesNumber, setPages] = useState("");
  ...
  let handleSubmit = async (e) => {
    ...
    try {
      ...
      if (bookCoverImage) {
        ...
        console.log(bookCoverImage.name, "bookCoverImage.name");
      }
      ...
      axios
        .post("http://localhost:3001/books", fd, {
          headers: {
      ...
      <div className="row">
        ...
        >
          ...
          <ul className="nav nav-pills flex-column mb-auto">
            ...
            <li>
              <Link to="/add-new-book" className="nav-link active">
                <svg className="bi me-2" width="16" height="16">
                  <use xlinkHref="#table" />
                </svg>
                Add New Book
